...
var VoiceRSS={
    ...
    _validate:function(e){
        ...
        if(e.c&&"auto"!=e.c.toLowerCase()){
            ...
            if(!a)throw"The browser does not support the audio codec "+e.
            c
        }
    },
    _request:function(e){
    ...
    _buildRequest:function(e){
        ...
        ;
        return"key="+(e.key||"")+"&src="+(e.src||"")+"&hl="+(e.
        hl||"")+"&v="+(e.v||"")+"&r="+(e.r||"")+"&c="+(a||"")+"&f="+(e.f||
        "")+"&ssml="+(e.ssml||"")+"&b64=true"
    },
...
/*function test() {
    VoiceRSS.speech({
        key: '26cf899053414fe1ae8563b9b3b69cec',
        src: 'GOOD NIGHT nithin akuva chayaku ',
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
        c: 'mp3',
